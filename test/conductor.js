  ...
  describe('blocking invocations', function () {
    ...
    describe('deserialize', function () {
      it('should deserialize a serialized composition', function () {
        ...
        return invoke(composer.parse(json), { message: 'hi' }).then(activation => assert.deepEqual(activation.response.result, { message: 'hi' }))
      })
    })
      ...
      describe('merge', function () {
        it('base case', function () {
          return invoke(composer.merge('TripleAndIncrement'), { n: 3, p: 4 })
            .then(activation => assert.deepEqual(activation.response.result, { n: 10, p: 4 }))
        })
      })
